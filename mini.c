...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(1,1,0);
 DrawTextXY(1.2,0.8,2.0,0.0010,"DEEKSHITHA K");
 DrawTextXY(1.2,0.6,2.0,0.0010,"4KM20CS012");
 DrawTextXY(-2.5,0.2,2.0,0.0010,"4KM20CS011");
 DrawTextXY(-2.5,0.4,2.0,0.0010,"DEEKSHITH");
 DrawTextXY(-2.5,0.8,2.0,0.0010,"ABHILASH N");
 DrawTextXY(-2.5,0.6,2.0,0.0010,"4KM20CS001");
  DrawTextXY(1.2,0.4,2.0,0.0010,"PRASHITHA CP");
 DrawTextXY(1.2,0.2,2.0,0.0010,"4KM20CS036");
  glFlush();
  glutSwapBuffers();
